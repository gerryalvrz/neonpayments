...
function YieldCardIcon() {
  return (
    ...
    >
      <rect
        strokeWidth={2}
        stroke="url(#np_yield_stroke)"
        fillOpacity="0.15"
        fill="url(#np_yield_fill)"
        rx={24}
        height={118}
        width={118}
        y={1}
      ...
      />
      <path
        className="fill-acid-lemon-dark dark:fill-[#ccff00]"
      ...
      <defs>
        <linearGradient
          ...
          id="np_yield_fill"
        >
          <stop stopOpacity="0.7" stopColor="#ccff00" />
          <stop stopOpacity={0} stopColor="#ccff00" offset="0.510417" />
          <stop stopOpacity="0.7" stopColor="#ccff00" offset={1} />
        </linearGradient>
        <radialGradient
        ...
        >
          ...
          <stop stopOpacity="0.25" stopColor="#5a6b14" offset={1} />
        </radialGradient>
      </defs>
    </svg>
  );
...
export function YieldCard({ title, description, detail, className }: YieldCardProps) {
  return (
    <div className={cn('max-w-[440px] w-full mx-auto border-0', className)}>
      <div
        className={cn(
          'relative rounded-[40px] p-8 sm:p-10',
          'bg-gradient-to-br from-white via-gray-50 to-white',
          'dark:from-[#0a0c02] dark:via-[#14180a] dark:to-[#0a0c02]',
      ...
      >
        ...
        <div
          aria-hidden
          className={cn(
            'absolute -inset-px rounded-[40px] -z-10',
            'bg-[linear-gradient(71deg,#e5e7eb,#ccff00,#e5e7eb)]',
            'dark:bg-[linear-gradient(71deg,#12150a,#ccff00,#12150a)]'
          )}
        />
        ...
        <h2 className="text-2xl md:text-3xl font-extrabold tracking-[-0.02em] leading-tight pb-2 text-gray-900 dark:text-white">
          {title}
        </h2>

        <p className="font-medium leading-7 text-base text-gray-600 dark:text-white/50 max-w-[470px]">
          {description}
        </p>

        {detail ? (
          <p className="mt-4 font-medium leading-7 text-base text-gray-500 dark:text-white/40 max-w-[470px]">
            {detail}
          </p>
        ) : null}
      </div>
