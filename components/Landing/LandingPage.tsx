...
const COPY = {
  en: {
    ...
    live: [
      ...
      {
        title: 'Send',
        body: 'To a wallet, a Celo name or a QR.',
      },
      {
        title: 'Receive',
        body: 'Share an address, a QR or a payment request.',
      },
      {
        title: 'Swap',
    ...
    <div className="min-h-screen">
      ...
      <Container>
        ...
        <section id="minipay" className="pb-16 md:pb-24 scroll-mt-24">
          <NeonHoverCard variant="premium" padding="xl" className="max-w-3xl mx-auto">
            <div className="p-3 bg-acid-lemon/15 rounded-xl inline-flex mb-4">
              <Icon color="neon" size="md">
                <CreditCardIcon />
              </Icon>
            </div>
