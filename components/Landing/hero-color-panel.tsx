...
const defaultDesktopShaderProps: Partial<ColorPanelsProps> = {
  width: 1280,
  height: 720,
  colors: ['#CCFF00', '#39FF14', '#6ef7cc', '#adfa1e'],
  colorBack: "#ffffff00",
  density: 5.03,
  angle1: 0.68,
  angle2: 0.28,
  ...
  return (
    ...
    >
      {children ?? (
        <p
          className={cn(
            "mt-0 mb-0 font-sans text-gray-600 dark:text-gray-300 text-sm sm:text-base lg:text-lg xl:text-xl",
            descriptionClassName
          )}
  ...
  return (
    ...
    >
      <a href={href} onClick={onClick} rel={rel} target={target}>
        <Button size="lg" className={cn(buttonClassName)} type="button">
          {label}
        </Button>
      </a>
    </div>
...
export function HeroColorPanelsMobileVisual({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="absolute inset-x-0 top-0 z-10 h-44 bg-gradient-to-b from-white via-white/90 to-transparent dark:from-gray-950 dark:via-gray-950/90" />
